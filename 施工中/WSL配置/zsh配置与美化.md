...
**摘自[zsh 安装与配置，使用 oh-my-zsh 美化终端 | Leehow的小站](https://www.haoyep.com/posts/zsh-config-oh-my-zsh/#配置主题)**
...
最后，记得[启用所有插件](https://www.haoyep.com/posts/zsh-config-oh-my-zsh/#启用插件)。
...
部分插件需要参考[插件介绍](https://www.haoyep.com/posts/zsh-config-oh-my-zsh/#插件介绍)进行安装。
